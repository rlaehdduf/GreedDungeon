...
public class ScriptableObjectAddressablesSetter : EditorWindow
{
    ...
    private static readonly Dictionary<string, string> SOToAddress = new Dictionary<string, string>
    {
        ...
        {"Equipment_1_막대기", "Equipments/Weapon/Stick"},
        {"Equipment_2_검", "Equipments/Weapon/Sword"},
        {"Equipment_3_방패", "Equipments/Weapon/Shield"},
        {"Equipment_4_완드", "Equipments/Weapon/Wand"},
        {"Equipment_5_도끼", "Equipments/Weapon/Axe"},
        {"Equipment_101_가죽갑옷", "Equipments/Armor/LeatherArmor"},
        {"Equipment_102_사슬갑옷", "Equipments/Armor/ChainArmor"},
        {"Equipment_103_강철갑옷", "Equipments/Armor/PlateArmor"},
        {"Equipment_104_가시갑옷", "Equipments/Armor/SpikeArmor"},
        {"Equipment_105_깃털갑옷", "Equipments/Armor/FeatherArmor"},
        {"Equipment_201_반지", "Equipments/Accessory/Ring"},
        {"Equipment_202_목걸이", "Equipments/Accessory/Necklace"},
        {"Equipment_203_망토", "Equipments/Accessory/Cloak"},
        {"Equipment_204_보석", "Equipments/Accessory/Jewel"},
        {"Equipment_205_왕관", "Equipments/Accessory/Crown"},
        
        {"Consumable_1_회복포션(소)", "Consumables/PotionSmall"},
        {"Consumable_2_회복포션(중)", "Consumables/PotionMedium"},
        {"Consumable_3_회복포션(대)", "Consumables/PotionLarge"},
        {"Consumable_4_해독제", "Consumables/Antidote"},
        {"Consumable_5_힘의물약", "Consumables/PowerPotion"},
        {"Consumable_6_철의물약", "Consumables/IronPotion"},
        {"Consumable_7_저주의물약", "Consumables/CursePotion"},
        {"Consumable_8_화염병", "Consumables/FlameBottle"},
        {"Consumable_9_마법화살", "Consumables/MagicArrow"},
        {"Consumable_10_폭발의서", "Consumables/ExplosionBook"},
